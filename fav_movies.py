...
Harry_Potter = media.Movie("Harry Potter and the Goblet of Fire",
	"Harry Potter's fourth year at Hogwarts as he is chosen by the Goblet of Fire to compete in the Triwizard Tournament.",
...
Chappie = media.Movie("Chappie",
	"The film, set and shot in johannesburg, is about an artificially intelligent law enforcement robot captured",
...
Legend = media.Movie("I Am Legend",
	"A genetically re-engineered measles virus, originally created as a cure for cancer, turns into a lethal",
